...
import { paginationModel,columnname,rowdata } from "../components/model_data/TenantInfo";
function TenantsInfo() {
  ...
  return (
    <>
      ...
      <BasicTable columnname={columnname} rowdata={rowdata} noOfColumns={5} initialState={paginationModel} tableName="Users" redirectTo="/TenantsIndividualinfo" />
    </>
  );
}
